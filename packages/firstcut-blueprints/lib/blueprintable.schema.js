...
/*#__PURE__*/
function (_FCSchema) {
  _inherits(BlueprintableSchema, _FCSchema);

  function BlueprintableSchema(props) {
    _classCallCheck(this, BlueprintableSchema);
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BlueprintableSchema).call(this, props));
  }

  _createClass(BlueprintableSchema, [{
