...
function RecordWithSchemaFactory(base, schema) {
  ...
  /*#__PURE__*/
  function (_base) {
    _inherits(RecordWithSchema, _base);

    function RecordWithSchema(properties) {
      _classCallCheck(this, RecordWithSchema);

      return _possibleConstructorReturn(this, _getPrototypeOf(RecordWithSchema).call(this, _objectSpread({}, properties)));
    }

    _createClass(RecordWithSchema, [{
      key: "schema",
      get: function get() {
