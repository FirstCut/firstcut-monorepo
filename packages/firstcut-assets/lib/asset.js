...
function (_Base) {
  ...
  (0, _createClass2.default)(Asset, [{
    ...
    key: "bucket",
    get: function get() {
      return this.meta.bucket || _meteor.Meteor.settings.public.s3.assets_bucket;
    },
    ...
    value: function getSnippetRequestFilename(_ref2) {
      ...
      return "".concat(snippetRequestPrefix, "_").concat(name, "_").concat(start, "_").concat(end, "_").concat(_random.Random.id(), ".").concat(snippetExtension);
    }
  }, {
    key: "insert",
    value: function insert(options) {
      ...
      record = record.set('_id', _random.Random.id());
