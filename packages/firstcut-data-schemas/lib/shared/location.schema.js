...
var _firstcutSchemaBuilder = _interopRequireDefault(require("firstcut-schema-builder"));

var _enum = require("./enum.js");

// import SimpleSchema from 'simpl-schema';
var LocationSchema = (0, _freeze.default)({
  location: {
    type: Object,
    customType: 'location',
...
function buildDisplayString(record, first_field, second_field) {
  ...
  if (first && second) return format(first, second);else if (first) return first;else if (second) return second;
}
